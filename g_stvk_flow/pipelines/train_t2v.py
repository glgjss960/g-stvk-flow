...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train g-STVK (text-to-video scaffold)")
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Optional override for conditional token slots (placeholder for T2V conditioning adapters).",
    )
